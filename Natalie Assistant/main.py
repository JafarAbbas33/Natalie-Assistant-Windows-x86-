                ...
                if len(resp.audio_out.audio_data) > 0:
                    ...
                    if not self.conversation_stream.playing:
                        if command_present(full_text):
                            self.conversation_stream.volume_percentage = 0
                        else:
...
########################################################################################################################
    ...
    def main(api_endpoint, credentials, project_id,
        ...
        global wait_for_user_trigger_, assistant_, once_
...
threading.Thread(target = GAss, daemon=True).start()
app_terminator.root = root
app_terminator.update_text = update_text
